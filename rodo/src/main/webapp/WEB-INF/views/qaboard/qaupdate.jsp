	    ...
	    <div class="container wow fadeInUp board-main">  
	      <div class="row">
	        <div class="col-md-12" style="padding-bottom:35px; padding-top: 40px;">
	          <span class="board-title">Q&A Update</span>
	          <div class="board-title-divider"></div>
	        </div>
	      </div> 

			<div>
				<div><b>TITLE</b><input type="text" name = "qa_title" id = "qa_title" value = "${board.qa_title}"></div>

				<div id="contents">
					
					<table id="filetable"><tr>
						<td class="filetitle">PHOTO FILE</td>
						<td><input type="file" id="upload2" name="upload2" size="30" accept=".png,.jpg,.gif" multiple = "multiple"></td>
					</tr></table>
					<input type = "hidden" name = "qa_boardnum" id = "qa_boardnum" value = "${board.qa_boardnum}">
					
					<div class="contentDiv">
						<b>CONTENTS</b><br><textarea id = "qa_content" name = "qa_content">${board.qa_content}</textarea>
					</div>
