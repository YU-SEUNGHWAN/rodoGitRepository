    ...
    <div class="container wow fadeInUp">
      <div class="row">
        <div class="col-md-12" style="padding-bottom:35px">
          <h3 class="section-title"> Q & A BOARD </h3>
       ...
       <div class="col-md-12" style="padding-bottom:35px">
       	 ...
       	 <c:forEach var="board" items="${list}">
        		<tr class = "tcolor">
        			...
        			<td style="text-align:left; width:57%;">
        				<a href="qaboardread?qa_boardnum=${board.qa_boardnum}" class="title">
        				${board.qa_title}	</a>	&nbsp; &nbsp;
		...
		<table style="width:100%;" class="board-navi">
			<tr>
				...
				<td style="width:20%"><a href="qaboardwrite" class="btn-write">Write</a></td>
			</tr>
		</table>

		<form action="qaboardlist" class="pull-right position" method = "get" id = "pagingForm">
