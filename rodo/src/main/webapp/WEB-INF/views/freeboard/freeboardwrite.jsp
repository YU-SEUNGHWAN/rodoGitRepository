	    ...
	    <div class="container wow fadeInUp board-main">  
	      <div class="row">
	        <div class="col-md-12" style="padding-bottom:35px; padding-top: 40px;">
	          <span class="board-title">Free Write</span>
	          <div class="board-title-divider"></div>
	        </div>
	      </div> 

			<div>
				<div><b>TITLE</b><input type="text" name = "free_title" id = "free_title"></div>
				...
				<div id="contents">
					...
					<div class="contentDiv">
						<b>CONTENTS</b><br><textarea id = "free_content" name = "free_content"></textarea>
					</div>
			...
			<div>
				<table id="buttontable"><tr>
					<td><input type="button" class="gpsbutton" value="back" onclick="javascript:location.href='freeboardlist'"></td>
