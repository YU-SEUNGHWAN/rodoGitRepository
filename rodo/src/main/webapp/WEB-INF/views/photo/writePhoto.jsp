	...
	<section id="services" style="background-color: #f6f6f6;">
	    <div class="container wow fadeInUp board-main">  
	      <div class="row">
			...
			<div>
				<div><b>TITLE</b><input type="text" name = "photo_title" id = "photo_title"></div>
				...
				<div id="contents">
					...
					<div class="contentDiv">
						<b>CONTENTS</b><br><textarea id = "photo_content" name = "photo_content"></textarea>
					</div>
			...
			<div>
				<table id="buttontable"><tr>
					...
					<td id="gpswrite"><input type="submit" id="save" class="gpsbutton" value="write"></td>
				</tr></table>
			</div>			
		</div>
	</section>
